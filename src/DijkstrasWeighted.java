...
public class DijkstrasWeighted {
    ...
    public DijkstrasWeighted(AirportGraph graph, int source) {
        this.graph = graph;
        this.source = source;
    ...
    private void relax(Path path) {
        ...
        for (AirportNode.Route edge : adj) {
            double newDistance = distTo[edge.source] + Double.parseDouble(edge.distance);
